...
class AppTest {
    ...
    // BEGIN
    @Test
    void testRegister() throws IOException, ParseException {
        CloseableHttpClient client = HttpClients.createDefault();
        ...
        List<NameValuePair> params = new ArrayList<>();
        params.add(new BasicNameValuePair("firstName", "fff"));
        params.add(new BasicNameValuePair("lastName", "lll"));
        params.add(new BasicNameValuePair("email", "sheesh@gmail.com"));
        params.add(new BasicNameValuePair("password", "pass"));
        ...
        assertThat(content).contains("Пользователь успешно создан");
        assertThat(content).contains("sheesh@gmail.com");
    }
    // END
