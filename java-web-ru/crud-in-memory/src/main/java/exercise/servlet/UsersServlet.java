...
public class UsersServlet extends HttpServlet {
    ...
    private void newUser(HttpServletRequest request,
        ...
        RequestDispatcher rq = request.getRequestDispatcher("/new.jsp");
    ...
    private void createUser(HttpServletRequest request,
        ...
        Map<String, String> newUser = new HashMap<>(Map.of("firstName", firstName,
                                                        "lastName", lastName,
                                                        "email", email));
    ...
    private void editUser(HttpServletRequest request,
        ...
        // BEGIN
        request.setAttribute("user", user);
        RequestDispatcher rq = request.getRequestDispatcher("/edit.jsp");
        rq.forward(request, response);
        // END
    }
    ...
    private void updateUser(HttpServletRequest request,
        ...
        Map<String, String> newUser = new HashMap<>(Map.of("id", user.get("id"),
                "firstName", firstName,
                "lastName", lastName,
                "email", email));
