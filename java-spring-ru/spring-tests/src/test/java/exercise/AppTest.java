...
public class AppTest {
    ...
    void testGetPersons() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentAsString()).contains("John", "Smith", "Jack", "Doe", "Simpson", "john@gmail.com");
    }
    ...
    void testPatchPerson() throws Exception {
        ...
        var existingUserId = TestUtils.getUserIdByEmail(mockMvc, existingUserEmail);
        PersonDto dto = new PersonDto();
        dto.setEmail("JACK@mail.com");
        dto.setFirstName("AMONGUS");
        dto.setLastName("SUS");
        MockHttpServletResponse response = mockMvc
        ...
        assertThat(repository.findByEmail("JACK@mail.com").getFirstName()).isEqualTo("AMONGUS");
        assertThat(repository.findByEmail("JACK@mail.com").getLastName()).isEqualTo("SUS");
    }
    // END
}
